...
バトル中にうんちくんがダメージを受けた瞬間、対象の名前/HP表記とHPバーが短時間だけ赤く点滅する演出を追加しました。既存のHP低下検知に乗せているため、ダメージ計算やバトル進行ロジックは変更していません。
...
- [ ] バトル中、味方うんちくんがダメージを受けた瞬間に名前/HP表記とHPバーが赤く点滅する
- [ ] バトル中、敵うんちくんがダメージを受けた瞬間に名前/HP表記とHPバーが赤く点滅する
