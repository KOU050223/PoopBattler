...
describe("createReportAnalysis", () => {
  ...
  it("食事タグは5件以上の記録かつ3件以上の関連がある場合だけ分析対象にする", () => {
    const analysis = createReportAnalysis({
      now: "2026-09-04T12:00:00.000Z",
      mealLogs: [
        { eatenAt: "2026-08-10T00:00:00.000Z", tag: "vegetable" },
        { eatenAt: "2026-08-17T00:00:00.000Z", tag: "vegetable" },
        { eatenAt: "2026-08-24T00:00:00.000Z", tag: "vegetable" },
        { eatenAt: "2026-08-31T00:00:00.000Z", tag: "vegetable" },
        { eatenAt: "2026-09-02T00:00:00.000Z", tag: "vegetable" },
